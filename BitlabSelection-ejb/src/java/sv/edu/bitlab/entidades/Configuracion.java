...
public class Configuracion implements Serializable {
    ...
    @Size(max = 200)
    @Column(name = "CON_CORREO", length = 200)
    private String conCorreo;
    @Size(max = 200)
    @Column(name = "CON_PCORREO", length = 200)
    private String conPcorreo;
    @Size(max = 200)
    @Column(name = "CON_PORT", length = 200)
    private String conPort;
    @Size(max = 200)
    @Column(name = "CON_SERVER", length = 200)
    private String conServer;
    @Size(max = 200)
    @Column(name = "CON_SEGURIDAD", length = 200)
    ...
    public String toString() {
        return "sv.edu.bitlab.entidades.Configuracion[ conId=" + conId + " ]";
    }
