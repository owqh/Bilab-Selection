 ...
 * @author Manuel
 */
@Named(value = "idiomaManged")
@SessionScoped
public class IdiomaManged implements Serializable {
    ...
    private List<Idioma> idiomaLista = null;
    
    /**
     * Creates a new instance of IdiomaManged
     */
    public IdiomaManged() {
    }
    ...
    public void nuevaEntidad() throws NoSuchMethodException{
        try {
            ...
            Logger.getLogger(IdiomaManged.class.getName()).log(Level.SEVERE, null, ex);
        }
